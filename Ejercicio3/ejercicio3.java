...
Para evitar que mueran cientos y cientos de peces, la ONG Salvemos los peces de colores ha decidido poner en cuarentena 
a 284 peces rojos y 163 peces azules en un gigantesco acuario, para devolverlos al mar cuando estén curados. 
...
public class ejercicio3 {
    public static void main(String[] args) {
        ...
        int  total_peces, peces_rojos = 284, peces_azules = 163;

            total_peces  = peces_rojos + peces_azules;

            System.out.println("los peces totales son: "+total_peces);
